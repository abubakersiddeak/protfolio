...
export default function Service() {
  return (
    <div className=" py-12 px-6 md:px-16 bg-[#111827]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative p-6 bg-white/5 backdrop-blur-2xl shadow-[0px_0px_20px_rgba(0,255,255,0.4)] rounded-2xl border border-cyan-400/30 transition duration-500 hover:shadow-[0px_0px_30px_rgba(0,255,255,0.7)] hover:bg-white/10">
        {services.map((service, index) => (
          ...
          >
            ...
            <p className="relative bg-gradient-to-r from-pink-300 to-yellow-400 text-transparent bg-clip-text font-semibold transition-all duration-300 mt-2">
              {service.description}
            </p>
          </motion.div>
        ))}
