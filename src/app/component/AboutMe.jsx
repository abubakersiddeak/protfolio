...
const AboutMe = () => {
  return (
    <div className="relative min-h-screen bg-[#111827] text-[#E2E8F0] rounded-2xl dark:bg-black ">
      {/* Background Overlay */}
      <div className="absolute inset-0 bg-black/30 backdrop-blur-[3px] rounded-3xl"></div>
      <Navbar />
      {/* About Content */}
